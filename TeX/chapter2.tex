...
\begin{theorem}[name=O strážnících, label=T-patrolmen]
...
\begin{definition}[name=Spojitost, label=D-continuity]
...
\begin{definition}[name=Složená funkce, label=compoundFunction]
