...
% % Need to add "\item[]" if theorem starts by enumerate.
...
\declaretheorem[numberwithin=chapter, name=Lemma]{lemmaAlph}
\renewcommand*{\thelemmaAlph}{\Alph{lemmaAlph}}
\declaretheorem[numberwithin=chapter, name=Věta]{theorem}
\declaretheorem[numberwithin=chapter, name=Věta]{theoremAlph}
\renewcommand*{\thetheoremAlph}{\Alph{theoremAlph}}
\declaretheorem[numberwithin=chapter, name=Vlastnost]{property}
